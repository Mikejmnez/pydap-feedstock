...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pydap-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pydap-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pydap pydap-server
# for installing globally
pixi global install pydap pydap-server
```
...
It is possible to list all of the versions of `pydap` available on your platform:
...
```
pixi search pydap --channel conda-forge
```
